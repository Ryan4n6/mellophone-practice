...
extension Note {
    ...
    static let all: [Note] = [
        Note(name: "F3",  frequency: 174.61,   staffPosition: 180,  fingering: "1+3",  accidental: .natural),
        Note(name: "F#3", frequency: 185.00,   staffPosition: 180,  fingering: "2+3",  accidental: .sharp),
        Note(name: "Gb3", frequency: 185.00,   staffPosition: 170,  fingering: "2+3",  accidental: .flat),
        Note(name: "G3",  frequency: 196.00,   staffPosition: 170,  fingering: "1+2",  accidental: .natural),
        Note(name: "Ab3", frequency: 207.65,   staffPosition: 160,  fingering: "1",    accidental: .flat),
        ...
        Note(name: "C#4", frequency: 277.18,   staffPosition: 140,  fingering: "1+2",  accidental: .sharp),
        Note(name: "Db4", frequency: 277.18,   staffPosition: 130,  fingering: "1+2",  accidental: .flat),
...
extension Scale {
    ...
    static let all: [Scale] = [
        ...
        Scale(name: "Long Tones (low)", noteNames: ["F3", "G3", "A3", "Bb3", "C4", "D4", "E4", "F4"]),
